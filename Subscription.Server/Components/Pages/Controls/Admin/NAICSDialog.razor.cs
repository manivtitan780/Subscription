...
// File Name:           NAICSDialog.razor.cs
...
public partial class NAICSDialog : ComponentBase
{
    private readonly NAICSValidator _naicsValidator = new();
    ...
    /// <summary>
    ///     Gets or sets the SfDialog control for the NAICSDialog.
    /// </summary>
    /// <remarks>
    ///     This property is used to control the dialog box in the NAICSDialog. It is used to show or hide the dialog box.
    ...
    private SfDataForm EditNAICSForm
    {
        get;
        set;
    }
    ...
    /// <summary>
    ///     Gets or sets the header string for the NAICSDialog.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets or sets the Model for the NAICSDialog.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets or sets the placeholder text for the TextBoxControl in the NAICSDialog.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets or sets the Save event callback that is triggered when the Save operation is performed in the NAICSDialog.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets or sets the SfSpinner control for the NAICSDialog.
    /// </summary>
    /// <remarks>
    ...
    /// <remarks>
    ///     This method is invoked when the user clicks on the Cancel button in the NAICSDialog.
    /// </remarks>
    /// <returns>A task that represents the asynchronous operation.</returns>
    private async Task CancelNAICS(MouseEventArgs args)
    {
        VisibleSpinner = true;
    ...
    /// <summary>
    ///     Asynchronously saves the administrative list in the NAICSDialog.
    /// </summary>
    ...
    /// </remarks>
    /// <returns>A task that represents the asynchronous operation.</returns>
    private async Task SaveNAICS(EditContext editContext)
    {
        VisibleSpinner = true;
    ...
    /// <summary>
    ///     Asynchronously displays the NAICSDialog.
    /// </summary>
    /// <remarks>
    ///     This method is used to display the NAICSDialog when it is required, such as during the editing of
