...
public partial class TaxTermDialog : ComponentBase
{
    private readonly TaxTermValidator _taxTermValidator = new();
    ...
    private async Task CancelTaxTerm(MouseEventArgs args)
    {
        VisibleSpinner = true;
    ...
    /// </remarks>
    /// <returns>A task that represents the asynchronous operation.</returns>
    private async Task SaveTaxTerm(EditContext editContext)
    {
        VisibleSpinner = true;
