...
// Last Updated On:     03-21-2025 16:03
// *****************************************/
...
public partial class StateDialog : ComponentBase
{
    ...
    /// <summary>
    ///     Gets or sets the SfDialog control for the StateDialog.
    /// </summary>
    /// <remarks>
    ///     This property is used to control the dialog box in the StateDialog. It is used to show or hide the dialog box.
    ...
    private SfDataForm EditStateForm
    {
        get;
        set;
    }
    ...
    /// <summary>
    ///     Gets or sets the Model for the StateDialog.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets or sets the placeholder text for the TextBoxControl in the StateDialog.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets or sets the Save event callback that is triggered when the Save operation is performed in the StateDialog.
    /// </summary>
    /// <remarks>
    ...
    /// <remarks>
    ///     This method is invoked when the user clicks on the Cancel button in the StateDialog.
    /// </remarks>
    /// <returns>A task that represents the asynchronous operation.</returns>
    private async Task CancelState(MouseEventArgs args)
    {
        VisibleSpinner = true;
    ...
    /// <summary>
    ///     Asynchronously saves the administrative list in the StateDialog.
    /// </summary>
    ...
    /// </remarks>
    /// <returns>A task that represents the asynchronous operation.</returns>
    private async Task SaveState(EditContext editContext)
    {
        VisibleSpinner = true;
    ...
    /// </summary>
    /// <remarks>
    ///     This method is used to display the StateDialog when it is required, such as during the editing of
