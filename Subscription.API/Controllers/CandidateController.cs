...
public class CandidateController : ControllerBase
{
    ...
    public async Task<List<CandidateEducation>> SaveEducation(CandidateEducation education, int candidateID, string user)
    {
        ...
        try
        {
            ...
            _education = await _reader.FillList<CandidateEducation>(candidateEducation => new()
                                                                                          {
                                                                                              ID = candidateEducation.GetInt32(0),
                                                                                              Degree = candidateEducation.GetString(1),
                                                                                              College = candidateEducation.GetString(2),
                                                                                              State = candidateEducation.GetString(3),
                                                                                              Country = candidateEducation.GetString(4),
                                                                                              Year = candidateEducation.GetString(5),
                                                                                              UpdatedBy = candidateEducation.GetString(6)
                                                                                          }).ToListAsync();
