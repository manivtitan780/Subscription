...
// Last Updated On:     3-14-2024 19:44
// *****************************************/
...
public class CompanyDetailsValidator : AbstractValidator<CompanyDetails>
{
    public CompanyDetailsValidator()
    {
        ...
        RuleFor(x => x.Name).NotEmpty().WithMessage("Company Name should not be empty.")
                            .Length(1, 100).WithMessage("Company Name should be less than {MaxLength} characters.");
        ...
        RuleFor(x => x.Website).MaximumLength(255).WithMessage("Website Address should be less than {MaxLength} characters.")
